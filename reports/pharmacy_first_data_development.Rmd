...
df_tab_pf_med_status_counts <- df_med_status_counts %>%
  ...
  relocate(
    med_status,
    # pre_anymed, pre_pfmed, pre_pfmedid,
    post_anymed, post_anypfid, post_anypfdate, post_pfmed, post_pfmedid, post_pfmedpfdate
  ) %>%
...
tab_pf_med_status_counts <- df_tab_pf_med_status_counts %>%
  ...
  cols_label(
    ...
    post_anymed = "Any",
    post_anypfid = "Any Med & Consult",
    post_anypfdate = "Any Med & Same Day",
    post_pfmed = "PF Med",
    post_pfmedid = "PF Med & Consult",
    post_pfmedpfdate = "PF Med & Same Day"
  ) %>%
  cols_align(
    align = "left",
    columns = med_status
  ...
  tab_footnote(
    footnote = "Any medication and Pharmacy First consultation.",
    locations = cells_column_labels(columns = c(post_anypfid))
  ) %>%
  tab_footnote(
    footnote = "Any medication and same day as Pharmacy First consultation.",
  ...
  tab_footnote(
    footnote = "Pharmacy First medications and same day as Pharmacy First consultation.",
