...
Initially, we investigated the 'medication status' field within the medications dataset by examining all possible values with counts over a one-year period. 
