...
pf_medications = medications.where(medications.consultation_id.is_in(pharmacy_first_ids)).where(medications.date.is_on_or_between(INTERVAL.start_date, INTERVAL.end_date))
...
measures.define_measure(
    ...
    group_by={"medication_status": pf_medications.medication_status},
